...
ask_permission()
{
  if [ $DO_SET_EXPORTS -ne 0 ]; then
    if [ $HAS_ANSWERED -ne 1 ]; then
      ...
      PS3="Enter 1, 2, or 3: ";
      options[0]="Yes, change my profile for me.";
      options[1]="No, I have set them myself, but continue.";
      options[3]="Quit, I will set them myself.";
...
if [[ "$MSYSTEM" == "MINGW32" ]]; then
  MINGW32EXPORTS=('export GITINSTALLDIR=/c/msysgit' \
